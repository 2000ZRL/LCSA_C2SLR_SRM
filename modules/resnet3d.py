...
# https://github.com/kennymckormick/pyskl/blob/main/pyskl/models/cnns/resnet3d.py
import warnings
    ...
    def _init_weights(self, pretrained=None):
        ...
        if isinstance(self.pretrained, str):
            if self.pretrained2d:
                print(f'load 2d weights from: {self.pretrained}')
...
if __name__ == '__main__':
    import torch as t
    model = ResNet3dSlowOnly(in_channels=17,
                            base_channels=32,
                            num_stages=3,
                            out_indices=(2, ),
                            stage_blocks=(3, 4, 6),
                            ...
                            pretrained="/2tssd/rzuo/pretrained_models/k400_posec3d_updkeys.pth",
                            pretrained2d=False)
    # print(model.state_dict().keys())
    model = model.cuda()
    x = t.rand(2,17,32,64,64).cuda()  #[B,K,T,H,W]
    y = model(x)
    print(y.shape)  #[2,512,16,8,8]
