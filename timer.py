...
def main():
    ...
    os.system("python main.py --config=config/csl-daily.yml --comb_conv=cas_bef_san --spatial_att=cbam --cbam_no_channel=1 --cbam_pool=max_softmax --att_idx_lst 4 --pose=super_att --sema_cons=batch --lr_factor=0.1 --save_dir=results/COR_CSLD_SI8_vgg11_cbs_C2SLR --gpu=0")
    ...
    # os.system("python main.py --config=config/csl-daily.yml --fde=xvec_rev --att_idx_lst 4 --pose=super_att --sema_cons=batch --fde_loss_w 0.75 1 0 0 --lr_factor=0.1 --save_dir=results/COR_CSLD_SI8_C2SLR_presigner_gradrev_jmlr.75 --gpu=1")
